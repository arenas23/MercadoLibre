...
import com.moviles.mercadolibreapp.Interface.FacturaService;
        ...
        switch (view.getId()){
            ...
            case R.id.btnCompraaaaar:
                ...
                if(listaProductos.size()>0){
                    ...
                    fechaString = df.format(fecha.getDate());
                    factura = new Factura(listaProductos,total,fechaString);
                /*Retrofit retrofit = new Retrofit.Builder()
                        .baseUrl("http://"+getString(R.string.IP)+"/features/")
                        .addConverterFactory(GsonConverterFactory.create())
                        .build();
                FacturaService facturaService = retrofit.create(FacturaService.class);
                Call<String> call = facturaService.setFactura(factura);
                call.enqueue(new Callback<String>() {
                    ...
                    mensaje.setMessage("el carrito esta vacio");
                    mensaje.setTitle("no hay nada que pagar");
                    mensaje.show();
                }
            ...
            public void onResponse(Call<ArrayList<Car>> call, Response<ArrayList<Car>> response) {
                ...
                if (response.isSuccessful()){
                    ...
                    if (listaProductos.size() > 0)
                    {
                        ...
                        total = String.valueOf(valorTotalCarrito);
